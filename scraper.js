...
require('teams.js'); // Load the team class from team.js
...
// ASync function for getting webpage info
(async () => {
    ...
    $('a', bodyHTML).each(function() {
        ...
        if ( isTeam($(this).text()) ) {
            ...
            let team = Team(teamName, teamURL);
    ...
    await page.click('.button[class="paginator-btn-nav"]');
